...
- **Validation gate (target):** `dotnet tool run hexalith-evidence validate _bmad-output/planning-artifacts/implementation-readiness-traceability-matrix.yaml` — tool status **not-available**; Builds runner candidate `4351d7cba7545a96661ca2ee2ca2629df6d0a118` and qualification revision `d3239aff003c64b40cbc074e68ec7923924cfc96` remain unaccepted, not an accepted published consumer capability
