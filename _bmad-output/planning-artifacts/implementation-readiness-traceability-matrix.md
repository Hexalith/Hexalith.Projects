...
| `fr-2` | FR-2 | Open Project — authorized metadata/lifecycle/setup/reference summary via supported read models | 6.1 | — | AD-3, AD-14, AD-19, AD-20, AD-32, AD-33 | 🔒 blocked-external | 6.1-P0..P4: G-4 runner, approved EventStore/Builds baseline, dual-principal identity, safe denial, global watermark, production auth contract, and accepted gate record |
...
| `fr-5` | FR-5 | List Projects — Tenant-scoped, authorization-filtered, cursor-paged | 6.1 | — | AD-14, AD-19, AD-20, AD-27 | 🔒 blocked-external | 6.1-P0..P4: G-4 runner, approved EventStore/Builds baseline, dual-principal identity, safe denial, global watermark, production auth contract, and accepted gate record |
...
| `nfr-5` | NFR-5 | Performance & scale — 10k Projects/Tenant, 5k refs/Project, 100k audit; reads p95 <500ms (<1s max); admission p95 <500ms warm | 8.9 | 6.1, 6.7 | AD-14, AD-15, AD-27 | 🔒 blocked-external | Story 6.1 P0/P1/P2/P4 runner, supported baseline, watermark, and accepted persisted-read evidence; final scale gate remains Story 8.9 |
...
| `nfr-10` | NFR-10 | Compatibility — additive/serialization-tolerant contracts; name-only creation preserved; retirement gated; no event-history rewrite | 6.7 | 6.1, 7.15, 8.7 | AD-6, AD-16, AD-17, AD-22 | 🔒 blocked-external | Story 6.1 P1/P4 version/source normalization and accepted compatibility baseline; final cutover gate remains Story 6.7 |
