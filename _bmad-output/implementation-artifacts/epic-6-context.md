...
- Story 6.1 and later consumers require accepted 6.1-P0, P1, P1R, P2, P3, and P4: runner/evidence tooling, a normalized EventStore/Builds baseline, dual-principal safe-query and watermark support, fail-closed production identity, and final gate acceptance. Historical P1 remains complete on `3.70.1`. P1R is open with EventStore source, Builds catalog, and runner candidate `4351d7cba7545a96661ca2ee2ca2629df6d0a118` aligned on `3.88.0`, with qualification revision `699083549932b9509fa36ed853402fe3f8b04fc5`, while the Architecture Spine remains on `3.70.1`; it must pass clean acceptance-grade validation, prove `3.70.1` as an executable rollback baseline, and receive EventStore Owner, Builds Owner, Solution Architect, and Test Architect acceptance.
- P0 remains externally in progress but blocked by P1R. P2 depends on P1, P3 on P2, and P4 on P0, P1, P1R, P2, and P3. Accepting P1R lets P0 consume the `3.88.0` tuple but does not close P0, P2, P3, P4, or Story 6.1.
