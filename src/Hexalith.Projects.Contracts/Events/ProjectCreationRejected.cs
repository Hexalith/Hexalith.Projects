// <copyright file="ProjectCreationRejected.cs" company="Hexalith">
...
/// <summary>
/// Rejection event emitted when a project-creation command is refused (AR-6, FS-4).
/// </summary>
/// <remarks>
...
/// harness (Story 1.4). The matching success event and command land with the create-project command
/// story (1.4), which emits this rejection via <c>Handle</c>.
/// </remarks>
/// <param name="TenantId">The managed tenant the rejected creation targeted.</param>
