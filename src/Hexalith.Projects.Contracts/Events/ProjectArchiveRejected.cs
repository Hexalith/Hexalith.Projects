// <copyright file="ProjectArchiveRejected.cs" company="Hexalith">
...
/// <summary>
/// Rejection event emitted when a project-archive command is refused (AR-6, FS-4).
/// </summary>
/// <remarks>
...
/// harness (Story 1.4). The matching success event and command land with the archive-project command
/// story (1.8), which emits this rejection via <c>Handle</c>.
/// </remarks>
/// <param name="ProjectId">The project whose archive was rejected.</param>
...
public sealed record ProjectArchiveRejected(
    ProjectId ProjectId,
    string TenantId,
