// <copyright file="ProjectReferenceLinkRejected.cs" company="Hexalith">
...
/// <summary>
/// Rejection event emitted when a request to link a sibling reference (conversation, folder, file,
/// memory) to a project is refused (AR-6, FS-4).
/// </summary>
/// <remarks>
...
/// matching success event and command land with the link/move command story (1.7).
/// </remarks>
/// <param name="ProjectId">The project the link targeted.</param>
...
public sealed record ProjectReferenceLinkRejected(
    ProjectId ProjectId,
    string TenantId,
