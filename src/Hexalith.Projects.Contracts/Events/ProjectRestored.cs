// <copyright file="ProjectRestored.cs" company="Hexalith">
...
/// <summary>
/// Success event emitted when a Project is restored from archived to active.
/// </summary>
...
/// <param name="Lifecycle">The lifecycle state after restore.</param>
...
public sealed record ProjectRestored(
    string TenantId,
    string ProjectId,
