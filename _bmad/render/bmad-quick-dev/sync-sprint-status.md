...
- `story_key` is unset
- `/home/administrator/projects/hexalith/projects/_bmad-output/implementation-artifacts/sprint-status.yaml` does not exist on disk

## Instructions

1. Load the FULL `/home/administrator/projects/hexalith/projects/_bmad-output/implementation-artifacts/sprint-status.yaml` file.
